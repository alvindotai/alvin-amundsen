...
print(os.getenv("ALVIN_INSTANCE_URL"))
...
# TABLEAU CONFIGURATION ENVIRONMENT VARIABLES
tableau_base_url = os.getenv("TABLEAU_API_BASE_URL")
tableau_api_base_url = os.getenv("TABLEAU_BASE_URL")
tableau_api_version = os.getenv("TABLEAU_API_VERSION")
tableau_site_name = os.getenv("TABLEAU_SITE_NAME")
tableau_personal_access_token_name = os.getenv("TABLEAU_PAT_NAME")
tableau_personal_access_token_secret = os.getenv("TABLEAU_PAT_SECRET")

tableau_excluded_projects = []  # type: ignore
tableau_dashboard_cluster = None
tableau_dashboard_database = None
tableau_external_table_cluster = None
tableau_external_table_schema = None
tableau_external_table_types = []  # type: ignore
tableau_verify_request = None

# ALVIN CONFIGURATION ENVIRONMENT VARS
alvin_instance_url = os.getenv("ALVIN_INSTANCE_URL")
alvin_api_key = os.getenv("ALVIN_API_KEY")
alvin_platform_id = os.getenv("ALVIN_TABLEAU_PLATFORM_ID")
alvin_platform_type = "tableau"
...
def create_es_publisher_sample_job(  # type: ignore
    ...
    dict_config.update(
        {
            ...
            "transformer.alvin_transformer.platform_id": alvin_platform_id,
            "transformer.alvin_transformer.platform_type": alvin_platform_type,
            "transformer.alvin_transformer.api_key": alvin_api_key,
            "transformer.alvin_transformer.alvin_instance_url": alvin_instance_url,
            "transformer.alvin_transformer.tableau_site_name": alvin_tableau_site_name,
        }
    )
    job_config = ConfigFactory.from_dict(dict_config)
    print(job_config)
    print(vars(job_config))
...
def run_tableau_last_modified_job():  # type: ignore
    task = DefaultTask(
...
def run_tableau_query_job():  # type: ignore
    task = DefaultTask(
...
def run_tableau_table_job():  # type: ignore
    task = DefaultTask(
...
def run_tableau_external_table_job():  # type: ignore
    task = DefaultTask(
